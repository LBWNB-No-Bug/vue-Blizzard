    ...
    <h1>账号详情</h1>
      <cardDiv text=个人信息 :width="long" >
        <el-row>
          ...
          <el-col class="detailComm" :span="14">这里是姓名</el-col>
        </el-row><el-row>
